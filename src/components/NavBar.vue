<template>
  <div class="fixed w-full flex justify-center top-6 z-50">
    <nav class="bg-white/60 dark:bg-gray-950/50 backdrop-blur-md text-gray-700 dark:text-gray-200 rounded-full shadow-lg transition-colors duration-300 mx-4 border border-gray-200/20 dark:border-gray-800/20">
      <div class="px-6 py-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700 border-2 border-gray-200/20 dark:border-gray-800/20">
              <img
                src="https://imgs.search.brave.com/GTciTfNisqdPU0yVTnpyoDolBSpKYl9K6y6H7BOjDlg/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMjAx/MzkxNTc2NC9waG90/by91c2VyLWljb24t/aW4tZmxhdC1zdHls/ZS5qcGc_cz02MTJ4/NjEyJnc9MCZrPTIw/JmM9UEotMnZvUWZh/Q3hhZUNsdzZYYlVz/QkNaT3NTTjlIVWVC/SUg1Qk82VmRScz0"
                alt="Profile"
          ...
          <!-- Added margin to create space between name and nav items -->
          ...
          <button @click="toggleMenu" class="md:hidden p-2 rounded-full hover:bg-white/80 dark:hover:bg-gray-800/60">
    ...
    <div v-show="isMenuOpen"
      ...
      <a
        ...
        :key="item"
        :href="'#' + item.toLowerCase()"
        @click.prevent="scrollToSection(item.toLowerCase()); closeMenu()"
        :class="[
